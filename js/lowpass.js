...
//-----------------snippet to select the waveform from DROPDOWN------------------------
function updateWaveform(value) {
  ...
  console.log("sine="+sine_flag);
  console.log("square="+sqre_flag);
  console.log("triangle="+tri_flag);
}
//----------------END OF DROPDOWN-------------------------
...
//---------------
console.log("co:"+coff_freq.value);
//------------EVENTS-----------------
//-----------------ON CLICKING BUTTON----------------------------
//getting the button object
SimulateButton=document.getElementById("SimulateButton");
SimulateButton.onclick= function(){pplot();}

//getting the dropdown object
dropDown = document.getElementById("selectWaveform");
dropDown.onchange=function(){updateWaveform(this.value);};
...
function pplot()
{
  if(sine_flag==1)
  {
    var a = coff_freq.value;
  var b = in_freq.value;
  var c = in_amp.value;"selectWaveform"
  sine(a,b,c);
  sine_flag=1;
  sqre_flag=0;
  tri_flag=0;
